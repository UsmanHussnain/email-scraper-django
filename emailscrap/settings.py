"""
Django settings for emailscrap project.
...
SECRET_KEY = 'django-insecure-hzyg8w&&&4hd0l%n5n5^lbf=(4npx58uavs@=f7hfmx)a9w0hv'
...
WSGI_APPLICATION = 'emailscrap.wsgi.application'
